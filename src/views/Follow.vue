        ...
        <div>
            <div id="container">
                <div v-for="(item,index) in favorites" :key="index">
                    <div class="body">
                        <p class="mt-3 fontGray margin-left-1">{{item.answer_author_name}}回答了问题·3小时前</p>
                        <img class="link mt-3 margin-left-1 display-inline" :src="item.creator_avatar">
                        <h2 class="mt-3 display-inline margin-left-1">{{item.creator_name}}&nbsp</h2>
