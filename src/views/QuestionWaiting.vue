        ...
        <div id="Qcontainer">
            <div v-for="(item,index) in favorited" :key="index">
                <div class="Qbody">
                    ...
                    ​<button class="Qnav" style="cursor:pointer;margin-top:5%;background-color: white;border: solid 1px cornflowerblue">
                ...
                <p class="fontGray" style="margin-left: 70%;margin-top: -2%">{{ item.comment_count }}个回答·{{item.total_count}}个浏览</p>
            </div>
        </div>
