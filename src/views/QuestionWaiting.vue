    ...
    <span>
      ...
      <ul>
        ...
        <div id="qita">
            ...
            <span class="massage" v-if="this.$store.state.token">2</span>
            <span v-else-if="!this.$store.state.token"></span>
            ...
            <span class="massage" v-if="this.$store.state.token">5</span>
            <span v-else-if="!this.$store.state.token"></span>                <a>
            <svg fill="currentColor" viewBox="0 0 24 24"
                 width="18" height="18">
            ...
            <span class="massage" v-if="this.$store.state.token">7</span>
            <span v-else-if="!this.$store.state.token"></span>
            ...
            <span class="massage" v-if="this.$store.state.token">8</span>
            <span v-else-if="!this.$store.state.token"></span>                <a>
            <svg fill="currentColor" viewBox="0 0 24 24"
                 width="18" height="18">
            ...
            <span class="massage" v-if="this.$store.state.token">10</span>
            <span v-else-if="!this.$store.state.token"></span>
        </div>
