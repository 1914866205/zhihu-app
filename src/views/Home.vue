<template>
    <div class="home" style="position: sticky">
        <img src="../assets/image/ad.png" width="46%" height="100px" style="margin-left: 14.5%;margin-top: 1.3%">
        <span>
        <div class="s-nav">
        ...
        <li class="margin-left-2">
            ...
            <!--      <ul>-->
            <!--        <li id="tujian" class="display-inline margin-left-1">-->
            <!--            <router-link  :class="{Snavcss : $route.path.substr(6,1)==='r'}" to="/home/recommened">推荐</router-link>-->
            <!--        </li>-->
            <!--        <li id="guanzhu"class="display-inline margin-left-2">-->
            <!--            <router-link :class="{Snavcss : $route.path.substr(6,1)==='f'}" to="/home/follow">关注</router-link>-->
            <!--        </li>-->
            <!--        <li id="rebang"class="display-inline margin-left-2">-->
            <!--            <router-link :class="{Snavcss : $route.path.substr(6,1)==='h'}" to="/home/hot">热榜</router-link>-->
            <!--        </li>-->
            <!--      </ul>-->
        </div>
    </span>
...
<style>
    ...
    .s-nav ul li  .router-link-active{
        color:black;
        font-weight: 600;
    }
